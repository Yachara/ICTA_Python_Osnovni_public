...
# sestevalnik = lambda x, y: x + y
# print(sestevalnik)
# print(type(sestevalnik))
# print(sestevalnik(2, 3))

# x = [10,5,4,3,7,6,8,9,1,2,]
# y = sorted(x)
# print(y)
...
# def sort_function(x):
#     print("Dobili smo", x["id"])
#     return x["current_price"]


# sorted_data = sorted(data, key=lambda x: x["current_price"])
# for i in sorted_data:
#     # print(i)
#     print(f"{i['id']} \t {i['current_price']}")

data = ["volk", "medved", "riba", "mačke", "pes"]
